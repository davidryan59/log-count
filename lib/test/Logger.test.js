...
describe('test Logger', () => {
  ...
  test('Can keep track of count of types supplied', () => {
    ...
    expect(tf.log7.count.testType).toEqual(2);
    expect(tf.log7.count.testType2).toEqual(3);
    expect(result).toEqual('');
  });
  ...
  test('level names', () => {
    ...
    tf.log0.debug();
    tf.log0.trace();
    expect(tf.log0.count.log_01_fatal).toEqual(1);
    expect(tf.log0.count.log_02_error).toEqual(1);
    expect(tf.log0.count.log_03_warn).toEqual(1);
    expect(tf.log0.count.log_04_success).toEqual(1);
    expect(tf.log0.count.log_05_info).toEqual(1);
    expect(tf.log0.count.log_06_debug).toEqual(1);
    expect(tf.log0.count.log_07_trace).toEqual(1);
    expect(Object.keys(tf.log0.count).length).toEqual(7);
  });
